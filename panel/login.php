                            ...
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <div class="login-image-content text-white">
                                    <div class="text-center">
                                        <img src="admin/images/logo.png" style="cursor:pointer;"
                                            alt="Admin Logo" class="align-self-center imgClick " height="200">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-5">
                                ...
                                <div class="text-center mb-4">
                                    <img src="admin/images/logo.png" alt="" class="brand-logo imgClick" style="cursor: pointer;">
                                ...
                                <form method="POST" action="<?= Helper::routers("login") ?>">
                                    ...
                                    <p class="text-muted mt-3"> Hesabınız Yok mu ? <a href="<?= Helper::base_site_url('panel/register.php') ?>">Kayıt Olun</a></p>
                                    <p class="text-muted mt-3"> Şiremi <a href="<?= Helper::base_site_url('panel/reset.php') ?>" style="color :#F05132"> unuttum ?</a></p>
    ...
    <script>
        document.querySelectorAll(".imgClick").forEach(function(element) {
            element.addEventListener("click", function() {
                window.location = "<?= Helper::base_site_url() ?>";
            });
        });
    </script>
